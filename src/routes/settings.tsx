  ...
  return (
    <div className="newspaper-container">
      <header className="newspaper-header">
        <button onClick={() => window.history.back()} className="back-btn" title="Back">
      ...
      <section className="settings-section">
        ...
        <div style={{ margin: '1.5rem 0', borderTop: '1px solid var(--rule-color)' }} />

        <p className="settings-description">
          Add RSS feeds to your feed. Feeds will be checked periodically for new articles.
        </p>
